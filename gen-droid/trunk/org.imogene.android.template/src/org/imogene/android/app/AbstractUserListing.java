...
public abstract class AbstractUserListing extends ListActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		UserCursorJoiner joiner = getCursor();
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		UserCursorJoiner cursor = (UserCursorJoiner) l.getAdapter().getItem(position);
	...
	protected abstract UserCursorJoiner getCursor();
	
	private static class JoinerAdapter extends CursorAdapter {

		public JoinerAdapter(Context context, UserCursorJoiner c) {
			super(context, c);
		}
