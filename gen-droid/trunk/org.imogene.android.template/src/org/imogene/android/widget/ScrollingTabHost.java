...
public class ScrollingTabHost extends FrameLayout implements
	...
	public ScrollingTabHost(Context context) {
		super(context);
		initTabHost();
	}

	public ScrollingTabHost(Context context, AttributeSet attrs) {
		super(context, attrs);
		initTabHost();
	}
	 ...
	 */
	public void setup() {
		mTabWidget = (ScrollingTabWidget) findViewById(android.R.id.tabs);
		if (mTabWidget == null) {
		...
		mTabWidget.setTabSelectionListener(new ScrollingTabWidget.OnTabSelectionChangedListener() {
	...
	public void onTouchModeChanged(boolean isInTouchMode) {
		if (!isInTouchMode) {
			...
			if (mCurrentView != null
				...
				if (mTabWidget != null)
					if (mTabWidget.getChildTabViewAt(mCurrentTab) != null)
						mTabWidget.getChildTabViewAt(mCurrentTab).requestFocus();
					else
						Log.i(ScrollingTabHost.class.getName(), "mTabWidget.getChildTabViewAt(mCurrentTab = "+mCurrentTab+") is null");
				else
					Log.i(ScrollingTabHost.class.getName(), "mTabWidget is null");
			}
		}
	}
...
//		}
		mTabWidget.addTab(tabIndicator);
	...
	public void setCurrentTab(int index) {
		...
		mCurrentTab = index;
		final ScrollingTabHost.TabSpec spec = mTabSpecs.get(index);
	...
	private class LabelIndicatorStrategy implements IndicatorStrategy {
		...
		public View createIndicatorView() {
			...
			View tabIndicator = inflater.inflate(W.layout.tab_indicator,
					mTabWidget, // tab widget is the parent
					false); // no inflate params

			final TextView tv = (TextView) tabIndicator.findViewById(W.id.title);
			tv.setText(mLabel);
...
//			}
	...
	private class LabelAndIconIndicatorStrategy implements IndicatorStrategy {
		...
		public View createIndicatorView() {
			...
			final ImageView iconView = (ImageView) tabIndicator.findViewById(W.id.icon);
