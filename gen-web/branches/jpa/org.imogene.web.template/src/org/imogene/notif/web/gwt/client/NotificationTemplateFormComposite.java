...
public class NotificationTemplateFormComposite extends AbstractFormComposite
		implements FieldValueChangeHandler {
	...
	/**
	 * create a biology form form the creation of a new instance.
	 */
	...
	/**
	 * Create a biology form to display or edit an existing boat.
	 * 
	 * @param entityID
	 *            the biology id
	 * @param editable
	 ...
	 */
	public NotificationTemplateFormComposite(ShortNameHelper helper,
			String entityId, boolean editable) {
	...
	/**
	 * set the behavior of the relation field embedded button.
	 */
	 ...
	 * @author Medes-IMPS
	 */
	private class PopulateWithNotification implements
			AsyncCallback<NotificationTemplate> {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.imogene.web.gwt.client.ui.field.FieldValueChangeHandler#
	 * onFieldValueChange(org.imogene.web.gwt.client.ui.field.ImogField)
	 */
	@Override
