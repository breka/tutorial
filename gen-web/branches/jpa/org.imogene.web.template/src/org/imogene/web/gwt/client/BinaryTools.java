 ...
 * 
 * A binary ID could be composed by a token which include severals information
 * about the referenced binary file. This token is at least composed by the
 * binary ID. It can propose more information separating information by '/', but
 * it should always start with binary ID.
 * 
