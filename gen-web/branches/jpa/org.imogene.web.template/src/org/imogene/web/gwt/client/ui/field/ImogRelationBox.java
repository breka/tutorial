 ...
 * @author Medes-IMPS
 */
public class ImogRelationBox<T extends ImogBean> extends ImogFieldAbstract<T>
	...
	private void properties() {
		...
		layout.setCellVerticalAlignment(listBox,
				HasVerticalAlignment.ALIGN_MIDDLE);
		layout.setCellHorizontalAlignment(listBox,
				HasHorizontalAlignment.ALIGN_LEFT);

		viewImage.setStyleName("imogene-FormImageLink");
		viewImage.setVisible(false);
		layout.setCellVerticalAlignment(viewImage,
				HasVerticalAlignment.ALIGN_MIDDLE);
		layout.setCellHorizontalAlignment(viewImage,
				HasHorizontalAlignment.ALIGN_LEFT);

		addImage.setStyleName("imogene-FormImageLink");
		layout.setCellVerticalAlignment(addImage,
				HasVerticalAlignment.ALIGN_MIDDLE);
		layout.setCellHorizontalAlignment(addImage,
				HasHorizontalAlignment.ALIGN_LEFT);
