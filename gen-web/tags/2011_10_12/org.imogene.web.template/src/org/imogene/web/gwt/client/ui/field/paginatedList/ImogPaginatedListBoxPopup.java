 ...
 * @author MEDES-IMPS
 */
public class ImogPaginatedListBoxPopup<T extends ImogBean> extends PopupPanel implements ClickHandler{
	
	
	private ImogPaginatedListBox<T> parentBox;
	
	/* case when the bean instance list is paginated through asynchronous call to the database */
	...
	/**
	 * Create a new ImogPaginatedListBoxPopup that will use 
	 * the specified data provider to retrieve bean instances by asynchronous calls to the database 
	 * @param provider The data provider
	 * @param mainFieldsUtil the utility class to get a display value of the list bean instances
	 * @param parentBox The parent composite
	 */
	public ImogPaginatedListBoxPopup(ImogPaginatedListBoxDataProvider provider, MainFieldsUtil mainFieldsUtil, ImogPaginatedListBox<T> parentBox){		
	...
	/**
	 * Create a new ImogPaginatedListBoxPopup whose bean instance list will be explicitly defined using the addItem method.
	 * @param parentBox The parent composite
	 */
	...
	/**
	 * Explicitly adds a bean instance to the list (to be used when the list is not paginated and no data provider is defined)
	 * Used after the constructor ImogPaginatedListBoxPopup(ImogPaginatedListBox<T> parentBox)
	 * @param display the bean display value
