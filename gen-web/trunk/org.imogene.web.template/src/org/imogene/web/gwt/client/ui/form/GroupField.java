 ...
 * @author Medes-IMPS
 */
public class GroupField extends DisclosureContainerComposite implements VisibilityChangeHandler {
	...
	public void onVisibilityChange(boolean visibility, ImogField<?> field) {
		for(int i=0; i<table.getRowCount(); i++){
			if(table.getCellCount(i)>1 && field.equals(table.getWidget(i, 1))){
