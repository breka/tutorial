...
public class RcpGenerationAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		try {
			...
			wizard.setWindowTitle("Generation of a RCP project");
			...
			wizard.setWorkflow("workflow/generatorMedooRcpPlugin.mwe");
			wizard.setIconCopyTask(new RcpIconCopyTask());
