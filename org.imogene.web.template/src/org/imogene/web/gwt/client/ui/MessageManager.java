...
public class MessageManager {
	 ...
	 * Ass a new info message.
	 * @param message the message text
	 * @param life the message life delay (in s);
	 * @return the message id in this session
	 */
	 ...
	 * @param message the message text
	 * @param life the message life (in s)
	 * @return the message id in this session
	 */
	 ...
	 * Add a new error message.
	 * @param message the message text
	 * @param delay the message life delay
	 * @return the message id in this session
	 */
	 ...
	 * @param message the new incoming message
	 * @param type the message type
	 * @param delay the delay this message is valid
	 * @return the message id in this session
	 */
