...
/**
 * ClientFilter Dao Implementation
 * @author Medes-IMPS
 */
public class ClientFilterDao implements EntityDao {
	...
	public Synchronizable loadEntity(String entityId) {
		return (ClientFilter) HibernateGenericDao.loadEntity(
				ClientFilter.class, entityId);
	}
	...
	public Synchronizable loadModified(Date date, ImogJunction criterions,
			String entityId) {
		return HibernateGenericDao.loadModified(ClientFilter.class, date,
				criterions, entityId);
	}
	...
	public void deleteEntities() {
		...
		String hsql = "delete from ClientFilter";
	...
	public int countAll() {
		...
		return HibernateGenericDao.countAll(ClientFilter.class, junction);
	}
	...
	public List<Synchronizable> loadEntities(ImogJunction junction) {
		return HibernateGenericDao.loadEntities(ClientFilter.class, junction);
	}
	...
	public List<Synchronizable> loadEntities(int startRow, int maxRows,
		...
		return HibernateGenericDao.loadEntities(ClientFilter.class,
	...
	public List<Synchronizable> loadModified(String modifiedBy, Date date,
		...
		return HibernateGenericDao.loadModified(ClientFilter.class, modifiedBy,
				date, criterions);
	}
