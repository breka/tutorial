 ...
 * @author MEDES-IMPS
 */
public class BinaryBlobStreamSerializer implements EntityStreamSerializer {

	private Logger logger = Logger
			.getLogger("org.imogene.sync.serializer.stream");
	...
	public Synchronizable deSerialize(DataInputStream data)	throws ImogSerializationException {
		...
		BinaryBlob entity = null;
		try {
			entity = new BinaryBlob();
			...
			entity.setContent(new FileInputStream(tempFile));
	...
	public void serialize(Synchronizable entity, DataOutputStream data)
		...
		try {
			BinaryBlob binary = (BinaryBlob) entity;
