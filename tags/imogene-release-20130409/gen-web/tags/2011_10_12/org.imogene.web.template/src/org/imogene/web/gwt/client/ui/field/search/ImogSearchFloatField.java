...
public class ImogSearchFloatField extends ImogSearchFieldAbstract<Float> {
	...
	protected void fillOperatorValues() {
		...
		thisOperator.addItem(BaseNLS.constants().search_operator_numeric_equal(), CriteriaConstants.FLOAT_OPERATOR_EQUAL);
		thisOperator.addItem(BaseNLS.constants().search_operator_superior(), CriteriaConstants.FLOAT_OPERATOR_SUP);
		thisOperator.addItem(BaseNLS.constants().search_operator_inferior(), CriteriaConstants.FLOAT_OPERATOR_INF);
