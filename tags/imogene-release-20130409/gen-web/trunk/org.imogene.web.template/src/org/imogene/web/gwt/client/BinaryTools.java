...
public class BinaryTools {
	...
	public static String DOWNLOAD_TMPL = "<a href=\""+GWT.getHostPageBaseURL()+"getbinary?binaryId=%PARAM_ID%\">"
	 					+"<img style=\"border:0;\" src=\""+GWT.getModuleBaseURL()+"images/download_24.png\"></a>";
