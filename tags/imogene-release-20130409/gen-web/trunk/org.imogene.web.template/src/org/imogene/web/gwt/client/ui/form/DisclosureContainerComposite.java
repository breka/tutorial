 ...
 * @author Medes-IMPS
 */
public class DisclosureContainerComposite extends Composite implements OpenHandler<DisclosurePanel>, CloseHandler<DisclosurePanel>{
	...
	private void properties(){	
		...
		contentPanel.setCellVerticalAlignment(imagePanel, HorizontalPanel.ALIGN_MIDDLE);
	}
	...
	private void layoutHeader(){	
		...
		/* icon */
		headerIcon = new Image(GWT.getModuleBaseURL() + "images/" + DEFAULT_ICON);
		/* label */
	...
	private void layoutProperties(){
		...
		headerPanel.setCellVerticalAlignment(headerIcon, HasVerticalAlignment.ALIGN_MIDDLE);
		/* label */
		...
		headerPanel.setCellHorizontalAlignment(buttonsPanel, HorizontalPanel.ALIGN_RIGHT);
		headerPanel.setCellVerticalAlignment(buttonsPanel, HasVerticalAlignment.ALIGN_MIDDLE);
		/* panel */
	 ...
	 * @param display true, to display the header icon.
	 */
