package org.imogene.webservice.contrib;
...
public class WebServiceGenerationAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		try {
			...
			wizard.setWindowTitle(Messages.WebServiceGenerationAction_0);
			...
			wizard.setDefinition(FileLocator.openStream(Activator.getDefault()
					...
					false));
			wizard.setWorkflow("workflow/generatorWebService.mwe"); //$NON-NLS-1$
