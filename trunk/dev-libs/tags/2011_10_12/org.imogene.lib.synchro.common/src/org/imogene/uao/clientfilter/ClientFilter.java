package org.imogene.uao.clientfilter;
 ...
 * @author MEDES-IMPS
 */
public class ClientFilter implements Synchronizable {
	...
	public String getDisplayValue() {
		...
		if (this.getUserId() != null)
			displayValue.append(this.getUserId()).append(" ");
		if (this.getCardEntity() != null)
			displayValue.append(this.getCardEntity()).append(" ");
