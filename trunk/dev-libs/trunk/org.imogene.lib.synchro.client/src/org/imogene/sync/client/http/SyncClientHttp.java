...
import org.imogene.sync.client.SyncClient;
...
public class SyncClientHttp implements SyncClient {
	...
	/*
	 * (non-Javadoc)
	 * @see org.imogene.sync.client.SyncClient#closeSession(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.imogene.sync.client.SyncClient#initSession(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.imogene.sync.client.SyncClient#requestServerModifications(java.lang.String, java.io.OutputStream)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.imogene.sync.client.SyncClient#sendClientModification(java.lang.String, java.io.InputStream)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.imogene.sync.client.SyncClient#directSend(java.lang.String, java.io.InputStream)
	 */
	...
	private int sendData(String sessionId, String cmd, InputStream data){
		try {
			...
			/* execute the request */
			MultipartRequestEntity mEntity = new MultipartRequestEntity(parts,
					method.getParams());
