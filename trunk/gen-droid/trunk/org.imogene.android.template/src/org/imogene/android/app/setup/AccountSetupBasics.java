...
import org.imogene.android.app.Authentication;
...
public class AccountSetupBasics extends Activity implements OnClickListener,
	...
	private void onNext() {
		...
		startActivityForResult(Authentication.getAuthenticationIntent(this, serverUrl, login, password, mHardwareId), ACTIVITY_AUTHENTICATION_ID);
	}
