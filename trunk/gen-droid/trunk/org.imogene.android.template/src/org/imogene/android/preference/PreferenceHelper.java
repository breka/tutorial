...
public class PreferenceHelper {
	...
	public static final long getNtpOffset(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context).getLong(
				context.getString(R.string.ntp_offset_key), 0);
	}

	public static final String getNtpServerUrl(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
				.getString(context.getString(R.string.ntp_server_key), "%Android_sntpServer%");
	}

	public static final String getShortPassword(Context context) {
		return getDecryptedString(context, context.getString(R.string.sync_shortpw_key));
	}

	public static final String getHardwareId(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
				.getString(context.getString(R.string.sync_hardware_key), null);
	}

	public static final String getServerUrl(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
				.getString(context.getString(R.string.sync_server_url_key),
						null);
	}
	
	public static final String getWebServiceUrl(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
				.getString(context.getString(R.string.webservice_url_key), null);
	}

	public static final boolean getSynchronizationStatus(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
				.getBoolean(context.getString(R.string.sync_on_off_key), false);
	}
	...
	public static final long getSynchronizationPeriod(Context context) {
		return Long.parseLong(PreferenceManager.getDefaultSharedPreferences(
				context).getString(context.getString(R.string.sync_time_key),
				"15"));
	}

	public static final boolean getSynchronizationBidirectional(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
				.getBoolean(context.getString(R.string.sync_bidirectional_key),
						true);
	}

	public static final long getSmsNumber(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context).getLong(
				context.getString(R.string.debug_smsnb_key), 0);
	}

	public static final boolean isDebugActive(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
				.getBoolean(context.getString(R.string.debug_save_key), false);
	}

	public static final String getEditionCategory(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
		.getBoolean(context.getString(R.string.app_wizard_key), false) ?
				Categories.CATEGORY_WIZARD : Categories.CATEGORY_CLASSIC;
	}
	
	public static final String getSyncLogin(Context context) {
		return getDecryptedString(context, context.getString(R.string.sync_login_key));
	}
	
	public static final String getSyncPassword(Context context) {
		return getDecryptedString(context, context.getString(R.string.sync_password_key));
	}
	
	public static final String getSyncRoles(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
		.getString(context.getString(R.string.sync_roles_key), null);
	}
	
	public static final boolean isMultilogin(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
				.getBoolean(context.getString(R.string.multilogin), false);
	}
	
	public static final String getCurrentLogin(Context context) {
		if (isMultilogin(context)) {
			String login = getDecryptedString(context, context.getString(R.string.current_login_key));
	...
	public static final String getCurrentRoles(Context context) {
		if (isMultilogin(context)) {
			...
			.getString(context.getString(R.string.current_roles_key), null);
	...
	public static final boolean isSetAdmin(Context context) {
		...
		return sp.contains(context.getString(R.string.admin_login_key))
		&& sp.contains(context.getString(R.string.admin_password_key))
		&& sp.contains(context.getString(R.string.admin_roles_key));
	}
	...
	public static final boolean isAdmin(Context context, String login, String password) {
		if (login != null & password != null & isSetAdmin(context)) {
			String adminLogin = getDecryptedString(context, context.getString(R.string.admin_login_key));
			String adminPassword = getDecryptedString(context, context.getString(R.string.admin_password_key));
	...
	public static final String getAdminRoles(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
		.getString(context.getString(R.string.admin_roles_key), null);
	}
	
	public static final boolean isHttpAuthenticated(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
				.getBoolean(context.getString(R.string.http_authentication_key),
						true);
	}
