 ...
 *
 */
public class NotificationTemplateListComposite extends Composite implements
		ClickHandler {

	private DynaTableWidget dynaTable;

	/**
	 * Creates the composite that displays entities in a table widget.
	 */
	...
	public NotificationTemplateListComposite(DynaTableDataProvider provider) {
		...
		columns[0] = new ColumnHeader("Name", "name");
		styles[0] = "style1";
		columns[1] = new ColumnHeader("Title", "title");
		styles[1] = "style1";
		/* IF YOU WANT TO USE AN AUTOREFRESH TABLE */
		/*
		 * dynaTable = new AutoRefreshDynaTableWidget(new
		 * NotificationTemplateDataProvider(), columns, styles, 15);
	...
	/**
	 * Method called when the composite is loaded Refreshes the enclosed
	 * dynatable
	 */
	public void onLoad() {
		dynaTable.refresh();
	...
	/**
	 * Unselect the row id that presents the entity with the specified ID.
	 * 
	 * @param id
	 *            The entity ID
	 */
