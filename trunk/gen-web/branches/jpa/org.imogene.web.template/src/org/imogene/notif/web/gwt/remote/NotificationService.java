...
public interface NotificationService extends RemoteService {
	 ...
	 */
	public List<NotificationTemplate> listNotification(int i, int j,
	 ...
	 */
	public List<NotificationTemplate> listNotification(int i, int j,
			ImogJunction criterion, String property, boolean sortOrder);
	...
	/**
	 * Count number of biology in the database, that matches the criteria
	 * 
	 * @return the count
	 */
