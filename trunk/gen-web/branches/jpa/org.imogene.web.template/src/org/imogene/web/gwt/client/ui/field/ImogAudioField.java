...
/**
 * Widgets that permits to display an edit an audio file. This widget proposes
 * to download the audio file or to play it in an embedded flash player
 * 
 * @author Medes-IMPS
 */
public class ImogAudioField extends ImogFieldAbstract<String> implements
		ClickHandler, SoundHandler, ImogUploader {
	...
	/**
	 * Create an audio field with an empty label
	 */
	...
	/**
	 * Create an audio field with the specified label
	 * 
	 * @param label
	 *            the field label
	 */
	...
	private void properties() {
		...
		main.setCellVerticalAlignment(playerStatus,
