 ...
 *            the field type
 */
public abstract class ImogFieldAbstract<T> extends Composite implements
		ImogField<T> {
	 ...
	 * 
	 * @param dependent
	 *            true if the field visibility is dependent
	 */
