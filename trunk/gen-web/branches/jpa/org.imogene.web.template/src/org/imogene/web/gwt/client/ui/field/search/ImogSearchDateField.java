...
public class ImogSearchDateField extends ImogSearchFieldAbstract<Date[]> {
	...
	private void properties() {
		...
		main.setCellVerticalAlignment(andLabel,
				HasVerticalAlignment.ALIGN_MIDDLE);
		main.setCellHorizontalAlignment(andLabel,
	...
	protected void fillOperatorValues() {
		...
		thisOperator.addItem(
				BaseNLS.constants().search_operator_date_between(),
				CriteriaConstants.DATE_OPERATOR_BETWEEN);
	...
	public boolean toBeSearched() {
		return (getOperatorValue() != null && getOperatorValue().equals(
				CriteriaConstants.OPERATOR_ISNULL))
				|| (getOperatorValue() != null
						&& getOperatorValue().equals(
								CriteriaConstants.DATE_OPERATOR_BETWEEN) && ((getFromDateDisplayValue() != null && !getFromDateDisplayValue()
						.equals("")) || (getToDateDisplayValue() != null && !getToDateDisplayValue()
						.equals(""))));
	}
