...
public class ImogSearchTextBox extends ImogSearchFieldAbstract<String> {
	...
	private void properties() {
		...
		layout.setCellVerticalAlignment(thisValue,
				HasVerticalAlignment.ALIGN_MIDDLE);
		layout.setCellHorizontalAlignment(thisValue,
	...
	protected void fillOperatorValues() {
		...
		thisOperator.addItem(BaseNLS.constants().search_operator_contains(),
				CriteriaConstants.STRING_OPERATOR_CONTAINS);
		thisOperator.addItem(BaseNLS.constants().search_operator_startwith(),
				CriteriaConstants.STRING_OPERATOR_STARTWITH);
