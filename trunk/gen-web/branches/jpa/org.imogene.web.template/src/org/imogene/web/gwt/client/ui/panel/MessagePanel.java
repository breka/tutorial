...
/**
 * Panel that permits to the application to display global messages to the user.
 * 
 * @author Medes-IMPS
 */
public class MessagePanel extends Composite implements MessageListener {
	...
	private void layout() {
		...
		messageIcon = new Image(GWT.getModuleBaseURL()
				+ "images/msg_info-16.png");
	...
	private void properties() {
		...
		messageLayout.setCellVerticalAlignment(messageIcon,
