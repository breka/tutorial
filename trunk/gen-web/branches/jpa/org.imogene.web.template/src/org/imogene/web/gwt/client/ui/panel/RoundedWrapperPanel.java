...
public class RoundedWrapperPanel extends Composite {
	...
	public RoundedWrapperPanel(Map<String, Command> commands, String pTitle,
			Widget pChild, String colorStyle) {
		child = pChild;
		title = pTitle;
		color = colorStyle;
	...
	private HorizontalPanel createTitlePanel() {
		...
		titlePanel
				.setCellVerticalAlignment(titleLabel, VerticalPanel.ALIGN_TOP);
		if (links != null) {
			for (Hyperlink link : links) {
				titlePanel.add(link);
				titlePanel.setCellHorizontalAlignment(link,
						HorizontalPanel.ALIGN_RIGHT);
				titlePanel.setCellVerticalAlignment(link,
						VerticalPanel.ALIGN_TOP);
			}
		}
		if (entityMenuBar != null) {
			titlePanel.add(entityMenuBar);
			titlePanel.setCellHorizontalAlignment(entityMenuBar,
					HorizontalPanel.ALIGN_RIGHT);
			titlePanel.setCellVerticalAlignment(entityMenuBar,
					VerticalPanel.ALIGN_TOP);
		}
		return titlePanel;
	}
