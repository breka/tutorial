...
public class DateUtil {
	...
	private static ResourceBundle rb = ResourceBundle
			.getBundle("org.imogene.web.gwt.client.i18n.ImogConstants");

	private static SimpleDateFormat dateFormater = new SimpleDateFormat(
			rb.getString("format_date"));
	private static SimpleDateFormat dateTimeFormater = new SimpleDateFormat(
			rb.getString("format_date") + " " + rb.getString("format_time"));
	private static SimpleDateFormat timeFormater = new SimpleDateFormat(
