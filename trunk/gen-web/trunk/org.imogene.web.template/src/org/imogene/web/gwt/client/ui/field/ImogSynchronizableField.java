...
public class ImogSynchronizableField extends ImogFieldAbstract<Set<SynchronizableEntity>> implements ClickHandler {
	...
	public void onClick(ClickEvent event) {		
		if(event.getSource().equals(add)){
			SynchronizableSelectionBox box = new SynchronizableSelectionBox(shortNames);
	...
	private class SynchronizableSelectionBox extends PopupPanel implements ClickHandler {
		...
		public void show(int left, int top){			
			...
			show();
			SynchronizableServiceFacade.getInstance().listAll(new AsyncCallback<List<SynchronizableEntity>>() {
				@Override
