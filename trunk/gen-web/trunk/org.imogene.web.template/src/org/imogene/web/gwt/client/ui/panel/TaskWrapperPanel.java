 ...
 * @author Medes-IMPS
 */
public class TaskWrapperPanel extends RoundedWrapperPanel implements ValueChangeHandler<String> {
	 ...
	 * @param pTitle the task composite title.
	 */
	 ...
	 * @param pTitle the task composite title
	 * @param pColor the task composite color
	 */
	 ...
	 * @param pTitle the task composite title
	 * @param pCommands the commands to add
	 */
	 ...
	 * @param pTitle the task composite title
	 * @param pColor the task composite color
	 * @param pCommands the commands to add in the header
	 */
	 ...
	 * (not including the first one which is the current child)
	 * @return
	 */
